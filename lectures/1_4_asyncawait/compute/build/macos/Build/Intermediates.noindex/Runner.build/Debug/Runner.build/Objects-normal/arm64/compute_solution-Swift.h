...
#ifndef COMPUTE_SOLUTION_SWIFT_H
#define COMPUTE_SOLUTION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="compute_solution",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC16compute_solution11AppDelegate")
...
SWIFT_CLASS("_TtC16compute_solution17MainFlutterWindow")
